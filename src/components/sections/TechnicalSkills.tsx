            ...
            <div key={group.title} className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {group.skills.map((skill) => (
                  <div
                    key={skill}
                    className={`bg-zinc-900 rounded-xl py-4 px-6 border border-accent hover:bg-accent/10 transition-all duration-300 cursor-pointer text-center motion-safe:animate-[float_3s_ease-in-out_infinite]
                  ...
                  >
                    <span className="text-xl font-semibold text-accent text-center block">{skill}</span>
                  </div>
                ))}
              </div>
            </div>
